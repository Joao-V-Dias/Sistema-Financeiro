...
public class DocumentoFiscalService implements GenericService<DocumentoFiscal>{
	...
	public void buscarTodos(){
		List<DocumentoFiscal> lstD = dDAO.buscarTodos();
		System.out.println("+----------------------------------------------------------------------------------------------------------------------------------------------+");
	 ...
	 */
	@Override
	public void buscar(DocumentoFiscal d){
	 ...
	 *
	 * @param d Será o objeto utilizado para sobrescrever o que ja esta no banco de dados
	 */
	@Override
